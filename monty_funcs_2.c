...
/**
 * monty_add - Adds top two values of the stack_t linked list.
...
/**
 * monty_sub - To subtract the second value from the top of
 ...
 *             top of the stack_t linked list  by the top value.
 * @stack: To point to the top mode node of the stack_t linked list.
 * @line_number: Current working line number of the Monty bytecodes file.
 *
 * Description: Result is stored in the second value node
